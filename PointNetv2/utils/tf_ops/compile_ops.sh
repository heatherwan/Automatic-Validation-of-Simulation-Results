...
g++ -std=c++11 -shared ./interpolation_3d/tf_interpolate.cpp -o ./interpolation_3d/tf_interpolate_so.so  -I $CUDA_ROOT/include -lcudart -L $CUDA_ROOT/lib64/ -fPIC ${TF_CFLAGS} ${TF_LFLAGS} -O2
